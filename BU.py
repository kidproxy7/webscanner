...
help: python3 BUWEBSCANNER.py -h
...
def update():
    os.system(
        "cd .. && rm -rf BUWEBSCANNER-Framework-New && mkdir BUWEBSCANNER-Framework-New && cd BUWEBSCANNER-Framework-New && git clone https://github.com/RedVirus0/BUWEBSCANNER-Framework.git && echo 'New Directory >> ' && pwd")
...
ex:
python3 BUWEBSCANNER.py --spider http://google.com
python3 BUWEBSCANNER.py --dork inurl:admin/login.php --country sa --text product
python3 BUWEBSCANNER.py --xss "paste url here"
python3 BUWEBSCANNER.py --sql "paste url here"
python3 BUWEBSCANNER.py --subdomain google.com
python3 BUWEBSCANNER.py --RevIP [ip address of server]
python3 BUWEBSCANNER.py --word redvirus --type md4
python3 BUWEBSCANNER.py --word redvirus --type md5
python3 BUWEBSCANNER.py --word redvirus --type sha1
python3 BUWEBSCANNER.py --word redvirus --type sha256
python3 BUWEBSCANNER.py --word redvirus --type sha512
python3 BUWEBSCANNER.py --hash_type 5f4dcc3b5aa765d61d8327deb882cf99
python3 BUWEBSCANNER.py --wordpress http://ebase.com/
python3 BUWEBSCANNER.py --wordpress http://ebase.com/ --ListUsername /root/Desktop/users.txt --ListPassowrd /root/Desktop/pass.txt
python3 BUWEBSCANNER.py --wordpress http://ebase.com/ --ListUsername /root/Desktop/users.txt 
python3 BUWEBSCANNER.py --wordpress http://ebase.com/ --ListPassword /root/Desktop/pass.txt
python3 BUWEBSCANNER.py --wordpress https://everythingrevelstoke.com --enum use
